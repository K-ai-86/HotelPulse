...
from dashboard.cadastro import render_cadastro
...
with st.sidebar:
    ...
    if st.button("📄 Relatórios", use_container_width=True):
        st.session_state.page = "relatorios"
    if st.button("📝 Cadastro de dados", use_container_width=True):
...
if st.session_state.page == "cadastro":
    render_cadastro(hotel_id, hotel_city)
else:
    # ... aqui entra TODO o código que já existe hoje,
    # desde "CABEÇALHO" até o final do arquivo (a quote card)
    ...
